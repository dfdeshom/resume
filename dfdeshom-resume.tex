...
\section{Executive Summary} 
  \cvline{Summary}{Python engineer who has designed and implemented
    large-scale production systems. Experienced with writing high-throughput RESTful APIs, web crawlers, and fast data processing pipelines for analytics and search workloads. Especially interested in systems where either data volume or velocity is high.
}
\cvline{Production Experience}{ AWS/EMR, Spark, Chef/Ansible, 
  Elasticsearch, Redshift, Kafka, MongoDB, Docker, DroneCI,
  Redis, Flask, Scrapy framework}
...
\section{Experience}
  ...
  \item Lead migration of over 30 internal python projects from
    ...
    projects,
    along with CI integration (using Drone CI) to ensure a safer transition.      
  ...
  \item Created  internal  RESTful web APIs for use by our data
    pipelines using Python, Flask and Celery. Created various ansible
