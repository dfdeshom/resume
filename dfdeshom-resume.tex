...
\section{Executive Summary} 
  \cvline{Summary:}{Backend Python engineer with experience in creating
...
\section{Experience} 
  \cventry{Spring 2009 - February 2016}{Systems and architecture Engineer}{Parse.ly}{New York, NY}{}{
      \begin{itemize}
        \item Designed and created an API for our publishers to access their
          analytics and recommmendations data. The API powers multiple
          ...
          . Technologies used: Tornado, Redis, MongoDB, ElasticSearch, Cassandra.
        \item Designed and created crawling system that processes millions of URLS per 
          month. Crawlers collect informative metadata from publishers' page for 
          display on the analytics dashboard. Technologies used:
          Scrapy, MongoDB, Redis. 
        \item  Implemented several features in our real-time and batch
          analytics pipeline that processes up to 10M events per
          day. Technologies used: MapReduce, Pig, Spark, Storm, ElasticSearch, Cassandra.  
        % \item Created a processing pipeline for crawled documents to enrich with 
        %   medata before saving to database. The metadata added include possible 
        %   topics for a given document and word count. 
          \item Designed and implemented flexible auto-complete search for our
            dashboard analytics users. With this feature, users were
            able to search millions of titles, authors and sections in
            a unified way and obtained results within 200ms.
        \item Automated  configuration and deployment for machines
          that were used to do API, crawling or search work using Chef
          and Vagrant.
        \item Designed and developped named entity recognition system using Solr, 
          the Wikipedia index, Wikipedia traffic data, and NLTK.
        \item Wrote and launch the backend prototype to the Parse.ly
  ...
  \cventry{Winter 2007 - Spring 2008}{Senior Python
    ...
    \begin{itemize}
      \item Designed and implemented an a keyword-matching algorithm
  ...
  \cventry{2007 - 2008}{Sotware
    Engineer}{Intelligent Information Systems}{Durham, NC}{}{
    \begin{itemize}
      ...
      \item Designed and implemented a website so clients could could
      ...
      \item Implemented and improved a procedure to port and test
        ...
        conversion tool and the Python scripting language. 
    \end{itemize}
  }
