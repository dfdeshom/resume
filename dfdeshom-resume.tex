...
\section{Executive Summary} 
  \cvline{Summary}{Python engineer who has designed and implemented
    ...
    deployment. Experienced with writing data processing pipelines for
...
\cvline{Production Experience}{ Python, AWS/EMR, Spark, Chef/Ansible, 
  ...
  Redis}
\cvline{Languages}{Python, Golang, Java}
\section{Experience}
  ...
  \item Responsible for maintaining and improving our data pipeline
    ...
    Spark jobs.
  \item Reduced cost of running daily EMR jobs by around 50\% in terms
