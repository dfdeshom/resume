...
\cvline{Technologies}{ Elasticsearch, Cassandra, Kafka, MongoDB,
  Redis, Solr, Pig, Spark, Storm, Django and Tornado web frameworks, Scrapy framework}
\cvline{Languages}{Python, Java}
\section{Experience} 
  \cventry{Spring 2011 - February 2016}{Backend Lead}{Parse.ly}{New York, NY}{}{
      \begin{itemize}
  ...
  \cventry{Summer 2009 - Sprint 2011}{Software Engineer \& Employee \#1}{Parse.ly}{New York, NY}{}{
    \begin{itemize}
      ...
      \item Wrote and launched the back-end to the Parse.ly Reader,
