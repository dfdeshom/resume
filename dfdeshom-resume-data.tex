...
\cvline{Production Experience}{ Python, AWS/EMR, Spark, Airflow, 
  Postgres, Elasticsearch, Redshift, Kafka, MongoDB, Docker, Snowflake,
  Redis}
\cvline{Languages}{Python, Golang}
\section{Experience}
  \cventry{January 2020 - }{Python Developer - Data Engineering team}{YouGov}{San
  Francisco, CA}{}{
\begin{itemize}
