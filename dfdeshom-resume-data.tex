...
\cvline{Current Production Experience}{ Python, AWS/EMR, Spark, Airflow, 
  Postgres,  Redshift,  Docker, Snowflake}
\cvline{Languages}{Python}
\section{Experience}
  \cventry{January 2020 - Present}{ Senior Software Engineer - Data Engineering team}{YouGov}{San
  Francisco, CA}{}{
  \begin{itemize}
  \item Led initiative to migrate most of our ETL jobs from an
    internal platform to Airflow/K8s.
  \item key reponsibilities include: monitoring our ETL jobs for
    failures, administering our Airflow infrastructure, making sure
    our K8s resource usage is optimized, maintaining and developping
    new and existing data engineering projects from conception to implementation  
  \item migrated several old ETL jobs to Airflow and/or  K8s
  \item Wrote and maintained hundreds of ETL jobs using Airflow.
